...
void runMergeTT(){
    ...
    // systematics --
    mergeTT("SMu",   1, 30, 0, 0, 0); // no bveto, doQCD=0, syst=1
    mergeTT("SMu",  -1, 30, 0, 0, 0); // no bveto, doQCD=0, syst=1
    mergeTT("SMu",   3, 30, 0, 0, 0); // no bveto, doQCD=0, syst=3
    mergeTT("SMu",  -3, 30, 0, 0, 0); // no bveto, doQCD=0, syst=3
    mergeTT("SMu",   5, 30, 0, 0, 0); // no bveto, doQCD=0, syst=5
    mergeTT("SMu",  -5, 30, 0, 0, 0); // no bveto, doQCD=0, syst=5
    mergeTT("SMu",  11, 30, 0, 0, 0); // no bveto, doQCD=0, syst=11
    mergeTT("SMu", -11, 30, 0, 0, 0); // no bveto, doQCD=0, syst=11
