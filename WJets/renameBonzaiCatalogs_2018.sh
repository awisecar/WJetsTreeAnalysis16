...
# data
# copy data bonzai catalogs like this,
# Bonzais-SingleMuon-all-VJetPruner-SMu-2018ABC.txt
# Bonzais-SingleMuon-all-VJetPruner-SMu-2018D.txt
# then do,
# cp Bonzais-SingleMuon-all-VJetPruner-SMu-2018ABC.txt SMu_13TeV_Data_dR_5311_List.txt
# cat Bonzais-SingleMuon-all-VJetPruner-SMu-2018D.txt >> SMu_13TeV_Data_dR_5311_List.txt
...
mv Bonzais-ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-madgraph-pythia8-all-VJetPruner-SMu.txt                  SMu_13TeV_ST_s_channel_dR_5311_List.txt
mv Bonzais-ST_t-channel_antitop_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8-all-VJetPruner-SMu.txt SMu_13TeV_ST_t_antitop_channel_dR_5311_List.txt
mv Bonzais-ST_t-channel_top_4f_InclusiveDecays_TuneCP5_13TeV-powheg-madspin-pythia8-all-VJetPruner-SMu.txt     SMu_13TeV_ST_t_top_channel_dR_5311_List.txt
mv Bonzais-ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                SMu_13TeV_ST_tW_antitop_channel_dR_5311_List.txt
mv Bonzais-ST_tW_top_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                    SMu_13TeV_ST_tW_top_channel_dR_5311_List.txt
mv Bonzais-TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                                       SMu_13TeV_TT_2L2Nu_dR_5311_List.txt
mv Bonzais-TTToHadronic_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                                    SMu_13TeV_TT_FullHad_dR_5311_List.txt
mv Bonzais-TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                                SMu_13TeV_TT_SemiLep_dR_5311_List.txt
...
mv Bonzais-WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                               SMu_13TeV_WWTo2L2Nu_dR_5311_List.txt
mv Bonzais-WWToLNuQQ_NNPDF31_TuneCP5_13TeV-powheg-pythia8-all-VJetPruner-SMu.txt                               SMu_13TeV_WWToLNuQQ_dR_5311_List.txt
...
mv Bonzais-ZZTo2L2Nu_TuneCP5_13TeV_powheg_pythia8-all-VJetPruner-SMu.txt                                       SMu_13TeV_ZZTo2L2Nu_dR_5311_List.txt
mv Bonzais-ZZTo2L2Q_13TeV_amcatnloFXFX_madspin_pythia8-all-VJetPruner-SMu.txt                                  SMu_13TeV_ZZTo2L2Q_dR_5311_List.txt
# mv Bonzais-WZ_TuneCP5_PSweights_13TeV-pythia8-all-VJetPruner-SMu.txt                                           SMu_13TeV_WZ_dR_5311_List.txt
