...
HistoSet::HistoSet(string leptonFlavor)
{
    ...
    bool doWJets = false;
    if ( leptonFlavor == "Muon" || leptonFlavor == "SMu" || leptonFlavor == "SMu_") {
        bool doWJets = true ;
        Mll = "M_{#mu#nu} [GeV]";
    ...
    int nJetPt_Zinc4jet(9);
    double jetPt_Zinc4jet[10] =  {20, 24, 30, 39, 49, 62, 78, 96, 150, 250};
    int nJetPt_Zinc5jet(9);
    double jetPt_Zinc5jet[10] =  {20, 24, 30, 39, 49, 62, 85, 120, 170, 250};
    ...
    int nJetHT_Zinc1jet(19);
    double jetHT_Zinc1jet[20] = {30, 39, 49, 62, 78, 96, 118, 150, 190, 240, 300, 370, 450, 540, 650, 820, 1100, 1500, 2000, 3000};
    int nJetHT_Zinc2jet(16);
    double jetHT_Zinc2jet[17] = {60, 78, 96, 118, 150, 190, 240, 300, 370, 450, 540, 650, 800, 1050, 1400, 1900, 2500};
    int nJetHT_Zinc3jet(12);
    double jetHT_Zinc3jet[13] = {90, 118, 168, 220, 300, 400, 525, 675, 850, 1050, 1300, 1600, 2000};
    int nJetHT_Zinc4jet(12);
    double jetHT_Zinc4jet[13] = {120, 140, 167, 203, 253, 320, 410, 530, 690, 910, 1200, 1600, 2000};
    int nJetHT_Zinc5jet(9);
    double jetHT_Zinc5jet[10] = {150, 180, 222, 282, 365, 485, 650, 880, 1200, 1600};
    int nJetHT_Zinc6jet(8);
    double jetHT_Zinc6jet[9] =  {180, 222, 282, 365, 485, 650, 880, 1200, 1600};
    ...
    int nJetMass_Zinc2jet(31);
    double ArrJetmass_Zinc2jet[32] = {0, 25, 52, 81, 112, 145, 180, 217, 256, 297, 340, 385, 432, 481, 532, 585, 640, 700, 765, 835, 910, 990, 1075, 1165, 1260, 1360, 1470, 1600, 1800, 2100, 2500, 3000};
    ...
    // binning without reducing jet pt cut to 20 GeV
    int nLepJetPt_gen_ZRatios(10);
    double lepJetPt_gen_ZRatios[11] = {55, 65, 80, 105, 140, 185, 235, 300, 400, 550, 900};
    int nLepJetPt_reco_ZRatios(20);
    double lepJetPt_reco_ZRatios[21] = {55, 60, 65, 72.5, 80, 92.5, 105, 122.5, 140, 162.5, 185, 210, 235, 267.5, 300, 350, 400, 475, 550, 725, 900};
    // binning with reducing jet pt cut to 20 GeV
    int nLepJetPt_INCLUDELOWPT_gen_ZRatios(12);
    double lepJetPt_INCLUDELOWPT_gen_ZRatios[13] = {45, 50, 55, 65, 80, 105, 140, 185, 235, 300, 400, 550, 900};
    int nLepJetPt_INCLUDELOWPT_reco_ZRatios(24);
    double lepJetPt_INCLUDELOWPT_reco_ZRatios[25] = {45, 47.5, 50, 52.5, 55, 60, 65, 72.5, 80, 92.5, 105, 122.5, 140, 162.5, 185, 210, 235, 267.5, 300, 350, 400, 475, 550, 725, 900};
    // old...
    ...
    int nWBosonJetPt_ZRatios(10);
    double wBosonJetPt_ZRatios[11] = {40, 60, 90, 130, 175, 230, 300, 400, 550, 900, 1500};
    // int nWBosonJetPt_1_ZRatios(5);
    ...
    // dijet mass (AK4)
    int nDijetMass_Zinc2jet(12);
    double dijetMass_Zinc2jet[13] = {0, 70, 150, 240, 350, 480, 650, 850, 1100, 1450, 2000, 3000, 4500};
    ...
    // updated binning for alternate selection, 10 MAR 21 ALW
    // int nLepJetAK8Pt_ZRatios(5);
    // double lepJetAK8Pt_ZRatios[6] = {300, 400, 550, 800, 1100, 1500};
    // ---
    // 16 APRIL 21 ALW
    ...
    // ---
    // ALW 19 MAY 21 -- 
    // using same bin structure for gen and reco distributions (reco binning will be split), and added an overflow bin
    int nLepJetAK8Pt_ZRatios(12);
    double lepJetAK8Pt_ZRatios[13] = {80, 100, 150, 200, 250, 315, 400, 500, 625, 800, 1050, 1400, 2000};
    // ---
    ...
    // dijet mass (ak8)
    int nDijetAK8Mass_Zinc2jet(12);
    double dijetAK8Mass_Zinc2jet[13] = {0, 70, 150, 240, 350, 480, 650, 850, 1100, 1450, 2000, 3000, 4500};
    ...
    // AK8 --
    ZNGoodJetsAK8_Zexc = newTH1D("ZNGoodJetsAK8_Zexc","AK8 Jet Counter (excl.)", "N_{jets, AK8}", 5, -0.5, 4.5);
    ZNGoodJetsAK8_Zexc->GetXaxis()->SetBinLabel(1, "= 0");
    ZNGoodJetsAK8_Zexc->GetXaxis()->SetBinLabel(2, "= 1");
    ZNGoodJetsAK8_Zexc->GetXaxis()->SetBinLabel(3, "= 2");
    ZNGoodJetsAK8_Zexc->GetXaxis()->SetBinLabel(4, "= 3");
    ZNGoodJetsAK8_Zexc->GetXaxis()->SetBinLabel(5, "= 4");

    ZNGoodJetsAK8_Zinc = newTH1D("ZNGoodJetsAK8_Zinc","AK8 Jet Counter (incl.)", "N_{jets, AK8}", 5, -0.5, 4.5);
    ZNGoodJetsAK8_Zinc->GetXaxis()->SetBinLabel(1, "#geq 0");
    ZNGoodJetsAK8_Zinc->GetXaxis()->SetBinLabel(2, "#geq 1");
    ZNGoodJetsAK8_Zinc->GetXaxis()->SetBinLabel(3, "#geq 2");
    ZNGoodJetsAK8_Zinc->GetXaxis()->SetBinLabel(4, "#geq 3");
    ZNGoodJetsAK8_Zinc->GetXaxis()->SetBinLabel(5, "#geq 4");
    ...
    // -------------- Lep pT + LJ pT -------------- 
    LepPtPlusLeadingJetPt_TUnfold_Zinc1jet = newTH1D("LepPtPlusLeadingJetPt_TUnfold_Zinc1jet", "lepton pt plus LJ pt for 1 inc jet", lpT_LJpT, nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios);
    LepPtPlusLeadingJetPt_TUnfold_Zinc2jet = newTH1D("LepPtPlusLeadingJetPt_TUnfold_Zinc2jet", "lepton pt plus LJ pt for 2 inc jet", lpT_LJpT, nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios);
    LepPtPlusLeadingJetPt_TUnfold_Zinc3jet = newTH1D("LepPtPlusLeadingJetPt_TUnfold_Zinc3jet", "lepton pt plus LJ pt for 3 inc jet", lpT_LJpT, nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios);
    LepPtPlusLeadingJetPt_TUnfold_Zinc4jet = newTH1D("LepPtPlusLeadingJetPt_TUnfold_Zinc4jet", "lepton pt plus LJ pt for 4 inc jet", lpT_LJpT, nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios);
    LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc1jet = newTH1D("LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc1jet", "lepton pt plus LJ pt for 1 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios);
    LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc2jet = newTH1D("LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc2jet", "lepton pt plus LJ pt for 2 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios);
    LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc3jet = newTH1D("LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc3jet", "lepton pt plus LJ pt for 3 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios);
    LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc4jet = newTH1D("LepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc4jet", "lepton pt plus LJ pt for 4 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios);

    genLepPtPlusLeadingJetPt_TUnfold_Zinc1jet = newTH1D("genLepPtPlusLeadingJetPt_TUnfold_Zinc1jet", "gen lepton pt plus LJ pt for 1 inc jet", lpT_LJpT, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    genLepPtPlusLeadingJetPt_TUnfold_Zinc2jet = newTH1D("genLepPtPlusLeadingJetPt_TUnfold_Zinc2jet", "gen lepton pt plus LJ pt for 2 inc jet", lpT_LJpT, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    genLepPtPlusLeadingJetPt_TUnfold_Zinc3jet = newTH1D("genLepPtPlusLeadingJetPt_TUnfold_Zinc3jet", "gen lepton pt plus LJ pt for 3 inc jet", lpT_LJpT, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    genLepPtPlusLeadingJetPt_TUnfold_Zinc4jet = newTH1D("genLepPtPlusLeadingJetPt_TUnfold_Zinc4jet", "gen lepton pt plus LJ pt for 4 inc jet", lpT_LJpT, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc1jet = newTH1D("genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc1jet", "gen lepton pt plus LJ pt for 1 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc2jet = newTH1D("genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc2jet", "gen lepton pt plus LJ pt for 2 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc3jet = newTH1D("genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc3jet", "gen lepton pt plus LJ pt for 3 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc4jet = newTH1D("genLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc4jet", "gen lepton pt plus LJ pt for 4 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);

    hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc1jet = newTH2D("hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc1jet", "hresp lepton pt plus LJ pt for 1 inc jet", nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc2jet = newTH2D("hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc2jet", "hresp lepton pt plus LJ pt for 2 inc jet", nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc3jet = newTH2D("hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc3jet", "hresp lepton pt plus LJ pt for 3 inc jet", nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc4jet = newTH2D("hresponseLepPtPlusLeadingJetPt_TUnfold_Zinc4jet", "hresp lepton pt plus LJ pt for 4 inc jet", nLepJetPt_reco_ZRatios, lepJetPt_reco_ZRatios, nLepJetPt_gen_ZRatios, lepJetPt_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc1jet = newTH2D("hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc1jet", "hresp lepton pt plus LJ pt for 1 inc jet", nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc2jet = newTH2D("hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc2jet", "hresp lepton pt plus LJ pt for 2 inc jet", nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc3jet = newTH2D("hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc3jet", "hresp lepton pt plus LJ pt for 3 inc jet", nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc4jet = newTH2D("hresponseLepPtPlusLeadingJetPt_INCLUDELOWPT_TUnfold_Zinc4jet", "hresp lepton pt plus LJ pt for 4 inc jet", nLepJetPt_INCLUDELOWPT_reco_ZRatios, lepJetPt_INCLUDELOWPT_reco_ZRatios, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    ...
    JetsHT_Zinc6jet            = newTH1D("JetsHT_Zinc6jet",                     "Scalar sum jets p_{T} (N_{jets} #geq 6)",     HT,     nJetHT_Zinc6jet, jetHT_Zinc6jet);
    ...
    //------ dRapidityJets -----------
    dRapidityJets_Zinc2jet              = newTH1D("dRapidityJets_Zinc2jet",         "#Delta y btwn jets (N_{jets} #geq 2)",    "#Deltay(j_{1 }j_{2})",  24, 0, 4.8);
    ...
    //------ dPhi Jets 1,2 -----------
    dPhiJets_Zinc2jet               = newTH1D("dPhiJets_Zinc2jet",            "#Delta#phi btwn jets (N_{jets} #geq 2)",        jdPhi,  40,  0, PI);
    ...
    //--- dPhi (muon, nth_jet) -----------
    dPhiLepJet1_Zinc1jet    = newTH1D("dPhiLepJet1_Zinc1jet",     "#Delta#phi btwn muon jet1 (N_{jets} #geq 1)", "#Delta#phi(#mu,j_{1})", 40,  0, PI);
    dPhiLepJet2_Zinc2jet    = newTH1D("dPhiLepJet2_Zinc2jet",     "#Delta#phi btwn muon jet2 (N_{jets} #geq 2)", "#Delta#phi(#mu,j_{2})", 40,  0, PI);
    dPhiLepJet3_Zinc3jet    = newTH1D("dPhiLepJet3_Zinc3jet",     "#Delta#phi btwn muon jet3 (N_{jets} #geq 3)", "#Delta#phi(#mu,j_{3})", 40,  0, PI);
    dPhiLepJet4_Zinc4jet    = newTH1D("dPhiLepJet4_Zinc4jet",     "#Delta#phi btwn muon jet4 (N_{jets} #geq 4)", "#Delta#phi(#mu,j_{4})", 40,  0, PI);
    dPhiLepJet5_Zinc5jet    = newTH1D("dPhiLepJet5_Zinc5jet",     "#Delta#phi btwn muon jet5 (N_{jets} #geq 5)", "#Delta#phi(#mu,j_{5})", 32,  0, PI);
    dPhiLepJet6_Zinc6jet    = newTH1D("dPhiLepJet6_Zinc6jet",     "#Delta#phi btwn muon jet6 (N_{jets} #geq 6)", "#Delta#phi(#mu,j_{6})", 32,  0, PI);
    ...
    dRapidityLepJet1_Zinc1jet = newTH1D("dRapidityLepJet1_Zinc1jet", "#Delta y btwn muon jet1 (N_{jets} #geq 1)",  "#Deltay(#mu,j_{1})",  24, 0, 4.8);
    dRapidityLepJet2_Zinc2jet = newTH1D("dRapidityLepJet2_Zinc2jet", "#Delta y btwn muon jet2 (N_{jets} #geq 2)",  "#Deltay(#mu,j_{2})",  24, 0, 4.8);
    dRapidityLepJet3_Zinc3jet = newTH1D("dRapidityLepJet3_Zinc3jet", "#Delta y btwn muon jet3 (N_{jets} #geq 3)",  "#Deltay(#mu,j_{3})",  24, 0, 4.8);
    dRapidityLepJet4_Zinc4jet = newTH1D("dRapidityLepJet4_Zinc4jet", "#Delta y btwn muon jet4 (N_{jets} #geq 4)",  "#Deltay(#mu,j_{4})",  24, 0, 4.8);
    dRapidityLepJet5_Zinc5jet = newTH1D("dRapidityLepJet5_Zinc5jet", "#Delta y btwn muon jet5 (N_{jets} #geq 5)",  "#Deltay(#mu,j_{5})",  20, 0, 4.8);
    dRapidityLepJet6_Zinc6jet = newTH1D("dRapidityLepJet6_Zinc6jet", "#Delta y btwn muon jet6 (N_{jets} #geq 6)",  "#Deltay(#mu,j_{6})",  20, 0, 4.8);

    //--- dR (muon, nth_jet) -----------
    dRLepJet1_Zinc1jet = newTH1D("dRLepJet1_Zinc1jet", "#Delta R btwn muon jet1 (N_{jets} #geq 1)",  "#DeltaR(#mu,j_{1})",   54,  0., 6.);
    dRLepJet2_Zinc2jet = newTH1D("dRLepJet2_Zinc2jet", "#Delta R btwn muon jet2 (N_{jets} #geq 2)",  "#DeltaR(#mu,j_{2})",   54,  0., 6.);
    dRLepJet3_Zinc3jet = newTH1D("dRLepJet3_Zinc3jet", "#Delta R btwn muon jet3 (N_{jets} #geq 3)",  "#DeltaR(#mu,j_{3})",   54,  0., 6.);
    dRLepJet4_Zinc4jet = newTH1D("dRLepJet4_Zinc4jet", "#Delta R btwn muon jet4 (N_{jets} #geq 4)",  "#DeltaR(#mu,j_{4})",   54,  0., 6.);
    dRLepJet5_Zinc5jet = newTH1D("dRLepJet5_Zinc5jet", "#Delta R btwn muon jet5 (N_{jets} #geq 5)",  "#DeltaR(#mu,j_{5})",   48,  0., 6.);
    dRLepJet6_Zinc6jet = newTH1D("dRLepJet6_Zinc6jet", "#Delta R btwn muon jet6 (N_{jets} #geq 6)",  "#DeltaR(#mu,j_{6})",   48,  0., 6.);
	...
	dRptmin100LepCloseJetCo300dR04_Zinc1jet			= newTH1D("dRptmin100LepCloseJetCo300dR04_Zinc1jet",          "#Delta R btwn muon closest jet Co 300 (N_{jets} #geq 1)",      "#DeltaR(#mu, closest jet)", 50,  0., 4.);
    ...
    //------ dR Jets -----------
    dRJets_Zinc2jet                 = newTH1D("dRJets_Zinc2jet",              "#Delta R btwn jets (N_{jets} #geq 2)",     "#DeltaR(j_{1 }j_{2})",   54,  0., 6.);
    ...
    SecondJetAbsRapidity_Zinc2jet          = newTH1D("SecondJetAbsRapidity_Zinc2jet",         "2nd jet |y| (N_{jets} #geq 2)",       "|y(j_{2})|",  24, 0, 2.4);
    ThirdJetAbsRapidity_Zinc3jet           = newTH1D("ThirdJetAbsRapidity_Zinc3jet",          "3rd jet |y| (N_{jets} #geq 3)",       "|y(j_{3})|",  24, 0., 2.4);
    FourthJetAbsRapidity_Zinc4jet          = newTH1D("FourthJetAbsRapidity_Zinc4jet",         "4th jet |y| (N_{jets} #geq 4)",       "|y(j_{4})|",  24, 0., 2.4);
    FifthJetAbsRapidity_Zinc5jet           = newTH1D("FifthJetAbsRapidity_Zinc5jet",          "5th jet |y| (N_{jets} #geq 5)",       "|y(j_{5})|",  20, 0., 2.4);
    SixthJetAbsRapidity_Zinc6jet           = newTH1D("SixthJetAbsRapidity_Zinc6jet",          "6th jet |y| (N_{jets} #geq 6)",       "|y(j_{6})|",  20, 0., 2.4);
    ...
    lepPt_Zinc0jet                      = newTH1D("lepPt_Zinc0jet",                      "1st & 2nd lep p_{T} (N_{jets} #geq 0)",       lpT,    158, 26, 500);
    lepPt_Zinc1jet                      = newTH1D("lepPt_Zinc1jet",                      "1st & 2nd lep p_{T} (N_{jets} #geq 1)",       lpT,    158, 26, 500);
    lepPt_Zinc2jet                      = newTH1D("lepPt_Zinc2jet",                      "1st & 2nd lep p_{T} (N_{jets} #geq 2)",       lpT,     74, 30, 400);
    lepPt_Zinc3jet                      = newTH1D("lepPt_Zinc3jet",                      "1st & 2nd lep p_{T} (N_{jets} #geq 3)",       lpT,     74, 30, 400);
    lepPt_Zinc4jet                      = newTH1D("lepPt_Zinc4jet",                      "1st & 2nd lep p_{T} (N_{jets} #geq 4)",       lpT,     74, 30, 400);
    lepPt_Zinc5jet                      = newTH1D("lepPt_Zinc5jet",                      "1st & 2nd lep p_{T} (N_{jets} #geq 5)",       lpT,     74, 30, 400);

    GLepBarePtZinc0jet                   = newTH1D("GLepBarePtZinc0jet",                   "gen 1st & 2nd lep p_{T} (N_{jets} #geq 0)",   lpT,     74, 30, 400);
    GLepBarePtZinc1jet                   = newTH1D("GLepBarePtZinc1jet",                   "gen 1st & 2nd lep p_{T} (N_{jets} #geq 1)",   lpT,     74, 30, 400);
    GLepBarePtZinc2jet                   = newTH1D("GLepBarePtZinc2jet",                   "gen 1st & 2nd lep p_{T} (N_{jets} #geq 2)",   lpT,     74, 30, 400);

    lepPt_Zexc0jet                      = newTH1D("lepPt_Zexc0jet",                      "1st & 2nd lep p_{T} (N_{jets} = 0)",          lpT,     74, 30, 400);
    lepPt_Zexc1jet                      = newTH1D("lepPt_Zexc1jet",                      "1st & 2nd lep p_{T} (N_{jets} = 1)",          lpT,     74, 30, 400);
    lepPt_Zexc2jet                      = newTH1D("lepPt_Zexc2jet",                      "1st & 2nd lep p_{T} (N_{jets} = 2)",          lpT,     74, 30, 400);
    lepPt_Zexc3jet                      = newTH1D("lepPt_Zexc3jet",                      "1st & 2nd lep p_{T} (N_{jets} = 3)",          lpT,     74, 30, 400);
    lepPt_Zexc4jet                      = newTH1D("lepPt_Zexc4jet",                      "1st & 2nd lep p_{T} (N_{jets} = 4)",          lpT,     74, 30, 400);
    lepPt_Zexc5jet                      = newTH1D("lepPt_Zexc5jet",                      "1st & 2nd lep p_{T} (N_{jets} = 5)",          lpT,     74, 30, 400);
    ...
    ZNGoodJetsChargePlus_Zinc = newTH1D("ZNGoodJetsChargePlus_Zinc","Jet Counter for W+ (incl.)", "N_{jets}", 11, -0.5, 10.5);
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(1, "#geq 0");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(2, "#geq 1");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(3, "#geq 2");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(4, "#geq 3");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(5, "#geq 4");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(6, "#geq 5");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(7, "#geq 6");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(8, "#geq 7");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(9, "#geq 8");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(10,"#geq 9");
    ZNGoodJetsChargePlus_Zinc->GetXaxis()->SetBinLabel(11,"#geq 10");

    ZNGoodJetsChargeMinus_Zinc = newTH1D("ZNGoodJetsChargeMinus_Zinc","Jet Counter for W- (incl.)", "N_{jets}", 11, -0.5, 10.5);
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(1, "#geq 0");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(2, "#geq 1");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(3, "#geq 2");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(4, "#geq 3");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(5, "#geq 4");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(6, "#geq 5");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(7, "#geq 6");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(8, "#geq 7");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(9, "#geq 8");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(10,"#geq 9");
    ZNGoodJetsChargeMinus_Zinc->GetXaxis()->SetBinLabel(11,"#geq 10");

    FirstJetPtChargePlus_Zinc1jet        = newTH1D("FirstJetPtChargePlus_Zinc1jet",       "1st jet p_{T} for W^{+} (N_{jets} #geq 1)",    "p_{T}(j_{1}) [GeV]",  nJetPt_Zinc1jet,   jetPt_Zinc1jet);
    FirstJetPtChargeMinus_Zinc1jet       = newTH1D("FirstJetPtChargeMinus_Zinc1jet",      "1st jet p_{T} for W^{-} (N_{jets} #geq 1)",    "p_{T}(j_{1}) [GeV]",  nJetPt_Zinc1jet,   jetPt_Zinc1jet);
    FirstJetAbsRapidityChargePlus_Zinc1jet       = newTH1D("FirstJetAbsRapidityChargePlus_Zinc1jet",          "1st jet |y| for W^{+} (N_{jets} #geq 1)",       "|y(j_{1})|",  24, 0, 2.4);
    FirstJetAbsRapidityChargeMinus_Zinc1jet      = newTH1D("FirstJetAbsRapidityChargeMinus_Zinc1jet",         "1st jet |y| for W^{-} (N_{jets} #geq 1)",       "|y(j_{1})|",  24, 0, 2.4);

    lepChargePlusPt_Zinc1jet    = newTH1D("lepChargePlusPt_Zinc1jet",  "lep+ p_{T} (N_{jets} #geq 1)", "p_{T}(#mu^{+}) [GeV]", 158, 26, 500);
    lepChargeMinusPt_Zinc1jet    = newTH1D("lepChargeMinusPt_Zinc1jet",  "lep- p_{T} (N_{jets} #geq 1)", "p_{T}(#mu^{-}) [GeV]", 158, 26, 500);
    ...
    ZPtChargePlus_Zinc1jet       = newTH1D("ZPtChargePlus_Zinc1jet",                        "W^{+} p_{T} (N_{jets} #geq 1)", ZpT, nWBosonJetPt_ZRatios, wBosonJetPt_ZRatios);
    ZPtChargeMinus_Zinc1jet      = newTH1D("ZPtChargeMinus_Zinc1jet",                       "W^{-} p_{T} (N_{jets} #geq 1)", ZpT, nWBosonJetPt_ZRatios, wBosonJetPt_ZRatios);
    ...
    NumRecoVtx_EvtSelection    = newTH1D("NumRecoVtx_EvtSelection", "Number of Reco Vertices for W+Jets selection", "#Vtx for event selection", 100, 0., 100.);
    ...
    MET_Zinc1jet                      = newTH1D("MET_Zinc1jet",                      "MET (N_{jets} #geq 1)",  "MET [GeV]",      100, 0., 500. );
    ...
    MT_Zinc0jet                      = newTH1D("MT_Zinc0jet",                      "MT (N_{jets} #geq 0)",    "MT [GeV]",   100, 0., 500. );
    MT_Zinc1jet                      = newTH1D("MT_Zinc1jet",                      "MT (N_{jets} #geq 1)",    "MT [GeV]",   100, 0., 500. );
    ...
    // Exclusive
    ZNGoodJets_Zexc_TUnfold = newTH1D("ZNGoodJets_Zexc_TUnfold","Jet Counter (excl.)", "N_{jets}", 11, -0.5, 10.5);
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(1, "= 0");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(2, "= 1");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(3, "= 2");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(4, "= 3");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(5, "= 4");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(6, "= 5");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(7, "= 6");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(8, "= 7");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(9, "= 8");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(10, "= 9");
    ZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(11, "= 10");

    genZNGoodJets_Zexc_TUnfold = newTH1D("genZNGoodJets_Zexc_TUnfold","Jet Counter (excl.)", "N_{jets}", 8, 0.5, 8.5);
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(1, "= 1");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(2, "= 2");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(3, "= 3");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(4, "= 4");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(5, "= 5");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(6, "= 6");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(7, "= 7");
    genZNGoodJets_Zexc_TUnfold->GetXaxis()->SetBinLabel(8, "= 8");

    hresponseZNGoodJets_Zexc_TUnfold = newTH2D("hresponseZNGoodJets_Zexc_TUnfold", "hresp ZNGoodJets_Zexc_TUnfold", 11, -0.5, 10.5, 8, 0.5, 8.5);
    hresponseZNGoodJets_Zexc_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseZNGoodJets_Zexc_TUnfold_NOEFFWEIGHTS", "hresp ZNGoodJets_Zexc_TUnfold", 11, -0.5, 10.5, 8, 0.5, 8.5);

    // Inclusive
    // ZNGoodJets_Zinc_TUnfold = newTH1D("ZNGoodJets_Zinc_TUnfold","Jet Counter (incl.)", "N_{jets}", 11, -0.5, 10.5);
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(1, "#geq 0");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(2, "#geq 1");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(3, "#geq 2");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(4, "#geq 3");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(5, "#geq 4");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(6, "#geq 5");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(7, "#geq 6");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(8, "#geq 7");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(9, "#geq 8");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(10,"#geq 9");
    // ZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(11,"#geq 10");

    // genZNGoodJets_Zinc_TUnfold = newTH1D("genZNGoodJets_Zinc_TUnfold","Jet Counter (incl.)", "N_{jets}", 8, 0.5, 8.5);
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(1, "#geq 1");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(2, "#geq 2");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(3, "#geq 3");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(4, "#geq 4");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(5, "#geq 5");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(6, "#geq 6");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(7, "#geq 7");
    // genZNGoodJets_Zinc_TUnfold->GetXaxis()->SetBinLabel(8, "#geq 8");

    // hresponseZNGoodJets_Zinc_TUnfold = newTH2D("hresponseZNGoodJets_Zinc_TUnfold", "hresp ZNGoodJets_Zinc_TUnfold", 11, -0.5, 10.5, 8, 0.5, 8.5);
    // hresponseZNGoodJets_Zinc_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseZNGoodJets_Zinc_TUnfold_NOEFFWEIGHTS", "hresp ZNGoodJets_Zinc_TUnfold", 11, -0.5, 10.5, 8, 0.5, 8.5);

    // --- AK8 ---

    // Exclusive
    ZNGoodJetsAK8_Zexc_TUnfold = newTH1D("ZNGoodJetsAK8_Zexc_TUnfold","AK8 Jet Counter (excl.)", "N_{jets, AK8}", 5, -0.5, 4.5);
    ZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(1, "= 0");
    ZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(2, "= 1");
    ZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(3, "= 2");
    ZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(4, "= 3");
    ZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(5, "= 4");

    genZNGoodJetsAK8_Zexc_TUnfold = newTH1D("genZNGoodJetsAK8_Zexc_TUnfold","AK8 Jet Counter (excl.)", "N_{jets, AK8}", 3, 0.5, 3.5);
    genZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(1, "= 1");
    genZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(2, "= 2");
    genZNGoodJetsAK8_Zexc_TUnfold->GetXaxis()->SetBinLabel(3, "= 3");

    hresponseZNGoodJetsAK8_Zexc_TUnfold = newTH2D("hresponseZNGoodJetsAK8_Zexc_TUnfold", "hresp ZNGoodJetsAK8_Zexc_TUnfold", 5, -0.5, 4.5, 3, 0.5, 3.5);
    hresponseZNGoodJetsAK8_Zexc_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseZNGoodJetsAK8_Zexc_TUnfold_NOEFFWEIGHTS", "hresp ZNGoodJetsAK8_Zexc_TUnfold", 5, -0.5, 4.5, 3, 0.5, 3.5);

    // Inclusive
    // ZNGoodJetsAK8_Zinc_TUnfold = newTH1D("ZNGoodJetsAK8_Zinc_TUnfold","AK8 Jet Counter (incl.)", "N_{jets, AK8}", 5, -0.5, 4.5);
    // ZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(1, "#geq 0");
    // ZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(2, "#geq 1");
    // ZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(3, "#geq 2");
    // ZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(4, "#geq 3");
    // ZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(5, "#geq 4");

    // genZNGoodJetsAK8_Zinc_TUnfold = newTH1D("genZNGoodJetsAK8_Zinc_TUnfold","AK8 Jet Counter (incl.)", "N_{jets, AK8}", 3, 0.5, 3.5);
    // genZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(1, "#geq 1");
    // genZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(2, "#geq 2");
    // genZNGoodJetsAK8_Zinc_TUnfold->GetXaxis()->SetBinLabel(3, "#geq 3");

    // hresponseZNGoodJetsAK8_Zinc_TUnfold = newTH2D("hresponseZNGoodJetsAK8_Zinc_TUnfold", "hresp ZNGoodJetsAK8_Zinc_TUnfold", 5, -0.5, 4.5, 3, 0.5, 3.5);
    // hresponseZNGoodJetsAK8_Zinc_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseZNGoodJetsAK8_Zinc_TUnfold_NOEFFWEIGHTS", "hresp ZNGoodJetsAK8_Zinc_TUnfold", 5, -0.5, 4.5, 3, 0.5, 3.5);

    // ---------------------------------------------------------------------------

    // reco histograms in this section have a "split in two" binning, 
    // meaning that it is the final binning, but then each bin is separately split in two
    // use split binning function to get new reco binning from one already declared above

    // --- First AK4 Jet Kinematics ---
    double jetPt_Zinc1jet_SPLIT[ (2 * nJetPt_Zinc1jet) + 1 ];
    splitBinsInTwoForTUnfold(nJetPt_Zinc1jet, jetPt_Zinc1jet, jetPt_Zinc1jet_SPLIT);
    ...
    FirstJetAbsRapidity_Zinc1jet_TUnfold                       = newTH1D("FirstJetAbsRapidity_Zinc1jet_TUnfold",          "1st jet |y| (N_{jets} #geq 1)",       "|y(j_{1})|",  24, 0, 2.4);
    genFirstJetAbsRapidity_Zinc1jet_TUnfold                    = newTH1D("genFirstJetAbsRapidity_Zinc1jet_TUnfold",       "gen 1st jet |y| (N_{jets} #geq 1)",   "|y(j_{1})|",  12, 0, 2.4);
    hresponseFirstJetAbsRapidity_Zinc1jet_TUnfold              = newTH2D("hresponseFirstJetAbsRapidity_Zinc1jet_TUnfold",   "hresp 1st jet |y| (N_{jets} #geq 1)", 24, 0, 2.4, 12, 0, 2.4);
    hresponseFirstJetAbsRapidity_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseFirstJetAbsRapidity_Zinc1jet_TUnfold_NOEFFWEIGHTS",   "hresp 1st jet |y| (N_{jets} #geq 1)", 24, 0, 2.4, 12, 0, 2.4);

    dPhiLepJet1_Zinc1jet_TUnfold                       = newTH1D("dPhiLepJet1_Zinc1jet_TUnfold",     "#Delta#phi btwn muon jet1 (N_{jets} #geq 1)", "#Delta#phi(#mu,j_{1})", 40,  0, PI);
    gendPhiLepJet1_Zinc1jet_TUnfold                    = newTH1D("gendPhiLepJet1_Zinc1jet_TUnfold",     "gen #Delta#phi btwn muon jet1 (N_{jets} #geq 1)", "#Delta#phi(#mu,j_{1})", 20,  0, PI);
    hresponsedPhiLepJet1_Zinc1jet_TUnfold              = newTH2D("hresponsedPhiLepJet1_Zinc1jet_TUnfold", "hresp #Delta#phi btwn muon jet1 (N_{jets} #geq 1)", 40,  0, PI, 20,  0, PI);
    hresponsedPhiLepJet1_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsedPhiLepJet1_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp #Delta#phi btwn muon jet1 (N_{jets} #geq 1)", 40,  0, PI, 20,  0, PI);

    // --- Second AK4 Jet Kinematics ---
    double jetPt_Zinc2jet_SPLIT[ (2 * nJetPt_Zinc2jet) + 1 ];
    splitBinsInTwoForTUnfold(nJetPt_Zinc2jet, jetPt_Zinc2jet, jetPt_Zinc2jet_SPLIT);
    SecondJetPt_Zinc2jet_TUnfold                       = newTH1D("SecondJetPt_Zinc2jet_TUnfold",       "2nd jet p_{T} (N_{jets} #geq 2)",    "p_{T}(j_{2}) [GeV]",  2 * nJetPt_Zinc2jet, jetPt_Zinc2jet_SPLIT);
    genSecondJetPt_Zinc2jet_TUnfold                    = newTH1D("genSecondJetPt_Zinc2jet_TUnfold",    "gen 2nd jet p_{T} (N_{jets} #geq 2)",  "p_{T}(j_{2}) [GeV]",   nJetPt_Zinc2jet, jetPt_Zinc2jet);
    hresponseSecondJetPt_Zinc2jet_TUnfold              = newTH2D("hresponseSecondJetPt_Zinc2jet_TUnfold", "hresp 2nd jet pt", 2 * nJetPt_Zinc2jet, jetPt_Zinc2jet_SPLIT, nJetPt_Zinc2jet, jetPt_Zinc2jet);
    hresponseSecondJetPt_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseSecondJetPt_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp 2nd jet pt", 2 * nJetPt_Zinc2jet, jetPt_Zinc2jet_SPLIT, nJetPt_Zinc2jet, jetPt_Zinc2jet);

    SecondJetAbsRapidity_Zinc2jet_TUnfold                       = newTH1D("SecondJetAbsRapidity_Zinc2jet_TUnfold",          "2nd jet |y| (N_{jets} #geq 2)",       "|y(j_{2})|",  24, 0, 2.4);
    genSecondJetAbsRapidity_Zinc2jet_TUnfold                    = newTH1D("genSecondJetAbsRapidity_Zinc2jet_TUnfold",       "gen 2nd jet |y| (N_{jets} #geq 2)",   "|y(j_{2})|",  12, 0, 2.4);
    hresponseSecondJetAbsRapidity_Zinc2jet_TUnfold              = newTH2D("hresponseSecondJetAbsRapidity_Zinc2jet_TUnfold",   "hresp 2nd jet |y| (N_{jets} #geq 2)", 24, 0, 2.4, 12, 0, 2.4);
    hresponseSecondJetAbsRapidity_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseSecondJetAbsRapidity_Zinc2jet_TUnfold_NOEFFWEIGHTS",   "hresp 2nd jet |y| (N_{jets} #geq 2)", 24, 0, 2.4, 12, 0, 2.4);

    dPhiLepJet2_Zinc2jet_TUnfold                       = newTH1D("dPhiLepJet2_Zinc2jet_TUnfold",     "#Delta#phi btwn muon jet2 (N_{jets} #geq 2)", "#Delta#phi(#mu,j_{2})", 36,  0, PI);
    gendPhiLepJet2_Zinc2jet_TUnfold                    = newTH1D("gendPhiLepJet2_Zinc2jet_TUnfold",     "gen #Delta#phi btwn muon jet2 (N_{jets} #geq 2)", "#Delta#phi(#mu,j_{2})", 18,  0, PI);
    hresponsedPhiLepJet2_Zinc2jet_TUnfold              = newTH2D("hresponsedPhiLepJet2_Zinc2jet_TUnfold", "hresp #Delta#phi btwn muon jet2 (N_{jets} #geq 2)", 36,  0, PI, 18,  0, PI);
    ...
    diJetMass_Zinc2jet_TUnfold = newTH1D("diJetMass_Zinc2jet_TUnfold", "Dijet Invariant Mass (N_{jets} #geq 2)", "M(j_{1 }j_{2})", 2 * nDijetMass_Zinc2jet, dijetMass_Zinc2jet_SPLIT);
    gendiJetMass_Zinc2jet_TUnfold = newTH1D("gendiJetMass_Zinc2jet_TUnfold", "gen Dijet Invariant Mass (N_{jets} #geq 2)", "M(j_{1 }j_{2})", nDijetMass_Zinc2jet, dijetMass_Zinc2jet);
    hresponsediJetMass_Zinc2jet_TUnfold = newTH2D("hresponsediJetMass_Zinc2jet_TUnfold", "hresp Dijet Invariant Mass (N_{jets} #geq 2)", 2 * nDijetMass_Zinc2jet, dijetMass_Zinc2jet_SPLIT, nDijetMass_Zinc2jet, dijetMass_Zinc2jet);
    hresponsediJetMass_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsediJetMass_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp Dijet Invariant Mass (N_{jets} #geq 2)", 2 * nDijetMass_Zinc2jet, dijetMass_Zinc2jet_SPLIT, nDijetMass_Zinc2jet, dijetMass_Zinc2jet);

    dRLepCloseJetCo300dR04_Zinc1jet_TUnfold = newTH1D("dRLepCloseJetCo300dR04_Zinc1jet_TUnfold", "#Delta R btwn muon closest jet Co 300 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 34,  0.4, 4.48);
	gendRLepCloseJetCo300dR04_Zinc1jet_TUnfold = newTH1D("gendRLepCloseJetCo300dR04_Zinc1jet_TUnfold", "gen #Delta R btwn muon closest jet Co 300 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 17,  0.4, 4.48);
	hresponsedRLepCloseJetCo300dR04_Zinc1jet_TUnfold = newTH2D("hresponsedRLepCloseJetCo300dR04_Zinc1jet_TUnfold", "hresp #Delta R btwn muon closest jet Co 300 (N_{jets} #geq 1)", 34,  0.4, 4.48, 17,  0.4, 4.48);
	hresponsedRLepCloseJetCo300dR04_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsedRLepCloseJetCo300dR04_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp #Delta R btwn muon closest jet Co 300 (N_{jets} #geq 1)", 34,  0.4, 4.48, 17,  0.4, 4.48);

    dRLepCloseJetCo500dR04_Zinc1jet_TUnfold = newTH1D("dRLepCloseJetCo500dR04_Zinc1jet_TUnfold", "#Delta R btwn muon closest jet Co 500 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 18,  0.4, 4.45);
	gendRLepCloseJetCo500dR04_Zinc1jet_TUnfold = newTH1D("gendRLepCloseJetCo500dR04_Zinc1jet_TUnfold", "gen #Delta R btwn muon closest jet Co 500 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 9,  0.4, 4.45);
	hresponsedRLepCloseJetCo500dR04_Zinc1jet_TUnfold = newTH2D("hresponsedRLepCloseJetCo500dR04_Zinc1jet_TUnfold", "hresp #Delta R btwn muon closest jet Co 500 (N_{jets} #geq 1)", 18,  0.4, 4.45, 9,  0.4, 4.45);
	hresponsedRLepCloseJetCo500dR04_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsedRLepCloseJetCo500dR04_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp #Delta R btwn muon closest jet Co 500 (N_{jets} #geq 1)", 18,  0.4, 4.45, 9,  0.4, 4.45);

    // --- First AK8 Jet Kinematics ---
    double jetAK8Pt_ZRatios_SPLIT[ (2 * nJetAK8Pt_ZRatios) + 1 ];
    splitBinsInTwoForTUnfold(nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios, jetAK8Pt_ZRatios_SPLIT);
    FirstJetAK8Pt_Zinc1jet_TUnfold                       = newTH1D("FirstJetAK8Pt_Zinc1jet_TUnfold",       "1st AK8 jet p_{T} (N_{jets, AK8} #geq 1)",    "p_{T}(j_{1}) [GeV]",  2 * nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios_SPLIT);
    genFirstJetAK8Pt_Zinc1jet_TUnfold                    = newTH1D("genFirstJetAK8Pt_Zinc1jet_TUnfold",    "gen 1st AK8 jet p_{T} (N_{jets, AK8} #geq 1)",  "p_{T}(j_{1}) [GeV]",   nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios);
    hresponseFirstJetAK8Pt_Zinc1jet_TUnfold              = newTH2D("hresponseFirstJetAK8Pt_Zinc1jet_TUnfold", "hresp 1st AK8 jet pt", 2 * nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios_SPLIT, nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios);
    hresponseFirstJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseFirstJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp 1st AK8 jet pt", 2 * nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios_SPLIT, nJetAK8Pt_ZRatios, jetAK8Pt_ZRatios);

    FirstJetAK8AbsRapidity_Zinc1jet_TUnfold                       = newTH1D("FirstJetAK8AbsRapidity_Zinc1jet_TUnfold",          "1st AK8 jet |y| (N_{jets, AK8} #geq 1)",       "|y(j_{1})|",  20, 0, 2.4);
    genFirstJetAK8AbsRapidity_Zinc1jet_TUnfold                    = newTH1D("genFirstJetAK8AbsRapidity_Zinc1jet_TUnfold",       "gen 1st AK8 jet |y| (N_{jets, AK8} #geq 1)",   "|y(j_{1})|",  10, 0, 2.4);
    hresponseFirstJetAK8AbsRapidity_Zinc1jet_TUnfold              = newTH2D("hresponseFirstJetAK8AbsRapidity_Zinc1jet_TUnfold",   "hresp 1st AK8 jet |y| (N_{jets, AK8} #geq 1)", 20, 0, 2.4, 10, 0, 2.4);
    hresponseFirstJetAK8AbsRapidity_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseFirstJetAK8AbsRapidity_Zinc1jet_TUnfold_NOEFFWEIGHTS",   "hresp 1st AK8 jet |y| (N_{jets, AK8} #geq 1)", 20, 0, 2.4, 10, 0, 2.4);

    dPhiLepJet1AK8_Zinc1jet_TUnfold                       = newTH1D("dPhiLepJet1AK8_Zinc1jet_TUnfold",     "#Delta#phi btwn muon AK8 jet1 (N_{jets, AK8} #geq 1)", "#Delta#phi(#mu,j_{1})", 20,  0, PI);
    gendPhiLepJet1AK8_Zinc1jet_TUnfold                    = newTH1D("gendPhiLepJet1AK8_Zinc1jet_TUnfold",     "gen #Delta#phi btwn muon AK8 jet1 (N_{jets, AK8} #geq 1)", "#Delta#phi(#mu,j_{1})", 10,  0, PI);
    hresponsedPhiLepJet1AK8_Zinc1jet_TUnfold              = newTH2D("hresponsedPhiLepJet1AK8_Zinc1jet_TUnfold", "hresp #Delta#phi btwn muon AK8 jet1 (N_{jets, AK8} #geq 1)", 20,  0, PI, 10,  0, PI);
    hresponsedPhiLepJet1AK8_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsedPhiLepJet1AK8_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp #Delta#phi btwn muon AK8 jet1 (N_{jets, AK8} #geq 1)", 20,  0, PI, 10,  0, PI);

    // --- Second AK8 Jet Kinematics ---
    // NOTE: currently using the same binning as the first AK8 jet pT distribution above
    double jetAK8Pt_Zinc2jet_SPLIT[ (2 * nJetAK8Pt_Zinc2jet) + 1 ];
    splitBinsInTwoForTUnfold(nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet_SPLIT);
    SecondJetAK8Pt_Zinc2jet_TUnfold                       = newTH1D("SecondJetAK8Pt_Zinc2jet_TUnfold",       "2nd AK8 jet p_{T} (N_{jets, AK8} #geq 2)",    "p_{T}(j_{2}) [GeV]",  2 * nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet_SPLIT);
    genSecondJetAK8Pt_Zinc2jet_TUnfold                    = newTH1D("genSecondJetAK8Pt_Zinc2jet_TUnfold",    "gen 2nd AK8 jet p_{T} (N_{jets, AK8} #geq 2)",  "p_{T}(j_{2}) [GeV]",   nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet);
    hresponseSecondJetAK8Pt_Zinc2jet_TUnfold              = newTH2D("hresponseSecondJetAK8Pt_Zinc2jet_TUnfold", "hresp 2nd AK8 jet pt", 2 * nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet_SPLIT, nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet);
    hresponseSecondJetAK8Pt_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseSecondJetAK8Pt_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp 2nd AK8 jet pt", 2 * nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet_SPLIT, nJetAK8Pt_Zinc2jet, jetAK8Pt_Zinc2jet);

    SecondJetAK8AbsRapidity_Zinc2jet_TUnfold                       = newTH1D("SecondJetAK8AbsRapidity_Zinc2jet_TUnfold",          "2nd AK8 jet |y| (N_{jets, AK8} #geq 2)",       "|y(j_{2})|",  20, 0, 2.4);
    genSecondJetAK8AbsRapidity_Zinc2jet_TUnfold                    = newTH1D("genSecondJetAK8AbsRapidity_Zinc2jet_TUnfold",       "gen 2nd AK8 jet |y| (N_{jets, AK8} #geq 2)",   "|y(j_{2})|",  10, 0, 2.4);
    hresponseSecondJetAK8AbsRapidity_Zinc2jet_TUnfold              = newTH2D("hresponseSecondJetAK8AbsRapidity_Zinc2jet_TUnfold",   "hresp 2nd AK8 jet |y| (N_{jets, AK8} #geq 2)", 20, 0, 2.4, 10, 0, 2.4);
    hresponseSecondJetAK8AbsRapidity_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseSecondJetAK8AbsRapidity_Zinc2jet_TUnfold_NOEFFWEIGHTS",   "hresp 2nd AK8 jet |y| (N_{jets, AK8} #geq 2)", 20, 0, 2.4, 10, 0, 2.4);

    dPhiLepJet2AK8_Zinc2jet_TUnfold                       = newTH1D("dPhiLepJet2AK8_Zinc2jet_TUnfold",     "#Delta#phi btwn muon AK8 jet2 (N_{jets, AK8} #geq 2)", "#Delta#phi(#mu,j_{2})", 20,  0, PI);
    gendPhiLepJet2AK8_Zinc2jet_TUnfold                    = newTH1D("gendPhiLepJet2AK8_Zinc2jet_TUnfold",     "gen #Delta#phi btwn muon AK8 jet2 (N_{jets, AK8} #geq 2)", "#Delta#phi(#mu,j_{2})", 10,  0, PI);
    hresponsedPhiLepJet2AK8_Zinc2jet_TUnfold              = newTH2D("hresponsedPhiLepJet2AK8_Zinc2jet_TUnfold", "hresp #Delta#phi btwn muon AK8 jet2 (N_{jets, AK8} #geq 2)", 20,  0, PI, 10,  0, PI);
    ...
    diJetAK8Mass_Zinc2jet_TUnfold = newTH1D("diJetAK8Mass_Zinc2jet_TUnfold", "AK8 Dijet Invariant Mass (N_{jets} #geq 2)", "M(j_{1 }j_{2})", 2 * nDijetAK8Mass_Zinc2jet, dijetAK8Mass_Zinc2jet_SPLIT);
    gendiJetAK8Mass_Zinc2jet_TUnfold = newTH1D("gendiJetAK8Mass_Zinc2jet_TUnfold", "gen AK8 Dijet Invariant Mass (N_{jets} #geq 2)", "M(j_{1 }j_{2})", nDijetAK8Mass_Zinc2jet, dijetAK8Mass_Zinc2jet);
    hresponsediJetAK8Mass_Zinc2jet_TUnfold = newTH2D("hresponsediJetAK8Mass_Zinc2jet_TUnfold", "hresp AK8 Dijet Invariant Mass (N_{jets} #geq 2)", 2 * nDijetAK8Mass_Zinc2jet, dijetAK8Mass_Zinc2jet_SPLIT, nDijetAK8Mass_Zinc2jet, dijetAK8Mass_Zinc2jet);
    hresponsediJetAK8Mass_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsediJetAK8Mass_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp AK8 Dijet Invariant Mass (N_{jets} #geq 2)", 2 * nDijetAK8Mass_Zinc2jet, dijetAK8Mass_Zinc2jet_SPLIT, nDijetAK8Mass_Zinc2jet, dijetAK8Mass_Zinc2jet);

    dRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold = newTH1D("dRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold", "#Delta R btwn muon closest AK8 jet Co 300 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 36,  0.8, 4.4);
	// gendRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold = newTH1D("gendRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold", "gen #Delta R btwn muon closest AK8 jet Co 300 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 18,  0.8, 4.4);
	// hresponsedRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold = newTH2D("hresponsedRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold", "hresp #Delta R btwn muon closest AK8 jet Co 300 (N_{jets} #geq 1)", 36,  0.8, 4.4, 18,  0.8, 4.4);
	// hresponsedRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsedRLepCloseAK8JetCo300dR08_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp #Delta R btwn muon closest AK8 jet Co 300 (N_{jets} #geq 1)", 36,  0.8, 4.4, 18,  0.8, 4.4);

    dRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold = newTH1D("dRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold", "#Delta R btwn muon closest AK8 jet Co 500 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 36,  0.8, 4.4);
	// gendRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold = newTH1D("gendRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold", "gen #Delta R btwn muon closest AK8 jet Co 500 (N_{jets} #geq 1)", "#DeltaR(#mu, closest jet)", 18,  0.8, 4.4);
	// hresponsedRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold = newTH2D("hresponsedRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold", "hresp #Delta R btwn muon closest AK8 jet Co 500 (N_{jets} #geq 1)", 36,  0.8, 4.4, 18,  0.8, 4.4);
	// hresponsedRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponsedRLepCloseAK8JetCo500dR08_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp #Delta R btwn muon closest AK8 jet Co 500 (N_{jets} #geq 1)", 36,  0.8, 4.4, 18,  0.8, 4.4);
    ...
    splitBinsInTwoForTUnfold(nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT);

    // inclusive
    LepPtPlusLeadingJetPt_Zinc1jet_TUnfold = newTH1D("LepPtPlusLeadingJetPt_Zinc1jet_TUnfold", "lepton pt plus LJ pt for 1 inc jet", lpT_LJpT, 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT);
    LepPtPlusLeadingJetPt_Zinc2jet_TUnfold = newTH1D("LepPtPlusLeadingJetPt_Zinc2jet_TUnfold", "lepton pt plus LJ pt for 2 inc jet", lpT_LJpT, 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT);
    LepPtPlusLeadingJetPt_Zinc3jet_TUnfold = newTH1D("LepPtPlusLeadingJetPt_Zinc3jet_TUnfold", "lepton pt plus LJ pt for 3 inc jet", lpT_LJpT, 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT);
    genLepPtPlusLeadingJetPt_Zinc1jet_TUnfold = newTH1D("genLepPtPlusLeadingJetPt_Zinc1jet_TUnfold", "gen lepton pt plus LJ pt for 1 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_Zinc2jet_TUnfold = newTH1D("genLepPtPlusLeadingJetPt_Zinc2jet_TUnfold", "gen lepton pt plus LJ pt for 2 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_Zinc3jet_TUnfold = newTH1D("genLepPtPlusLeadingJetPt_Zinc3jet_TUnfold", "gen lepton pt plus LJ pt for 3 inc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    ...
    hresponseLepPtPlusLeadingJetPt_Zinc1jet_TUnfold_NOEFFWEIGHTS  = newTH2D("hresponseLepPtPlusLeadingJetPt_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 1 inc jet", 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_Zinc2jet_TUnfold_NOEFFWEIGHTS  = newTH2D("hresponseLepPtPlusLeadingJetPt_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 2 inc jet", 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_Zinc3jet_TUnfold_NOEFFWEIGHTS  = newTH2D("hresponseLepPtPlusLeadingJetPt_Zinc3jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 3 inc jet", 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    ...
    LepPtPlusLeadingJetPt_Zexc2jet_TUnfold = newTH1D("LepPtPlusLeadingJetPt_Zexc2jet_TUnfold", "lepton pt plus LJ pt for 2 exc jet", lpT_LJpT, 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT);
    LepPtPlusLeadingJetPt_Zexc3jet_TUnfold = newTH1D("LepPtPlusLeadingJetPt_Zexc3jet_TUnfold", "lepton pt plus LJ pt for 3 exc jet", lpT_LJpT, 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT);
    genLepPtPlusLeadingJetPt_Zexc1jet_TUnfold = newTH1D("genLepPtPlusLeadingJetPt_Zexc1jet_TUnfold", "gen lepton pt plus LJ pt for 1 exc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_Zexc2jet_TUnfold = newTH1D("genLepPtPlusLeadingJetPt_Zexc2jet_TUnfold", "gen lepton pt plus LJ pt for 2 exc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    genLepPtPlusLeadingJetPt_Zexc3jet_TUnfold = newTH1D("genLepPtPlusLeadingJetPt_Zexc3jet_TUnfold", "gen lepton pt plus LJ pt for 3 exc jet", lpT_LJpT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    ...
    hresponseLepPtPlusLeadingJetPt_Zexc1jet_TUnfold_NOEFFWEIGHTS  = newTH2D("hresponseLepPtPlusLeadingJetPt_Zexc1jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 1 exc jet", 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_Zexc2jet_TUnfold_NOEFFWEIGHTS  = newTH2D("hresponseLepPtPlusLeadingJetPt_Zexc2jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 2 exc jet", 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    hresponseLepPtPlusLeadingJetPt_Zexc3jet_TUnfold_NOEFFWEIGHTS  = newTH2D("hresponseLepPtPlusLeadingJetPt_Zexc3jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 3 exc jet", 2 * nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios_SPLIT, nLepJetPt_INCLUDELOWPT_gen_ZRatios, lepJetPt_INCLUDELOWPT_gen_ZRatios);
    ...
    double lepJetAK8Pt_ZRatios_SPLIT[ (2 * nLepJetAK8Pt_ZRatios) + 1 ];
    splitBinsInTwoForTUnfold(nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT);

    // inclusive
    // standard choice where reco binning is just gen binning with each bin split into two --
    LepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold", "lepton pt plus LJ pt for 1 AK8 inc jet", lpT_LJpT, 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT);
    LepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold", "lepton pt plus LJ pt for 2 AK8 inc jet", lpT_LJpT, 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT);
    genLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold", "gen lepton pt plus LJ pt for 1 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    genLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold", "gen lepton pt plus LJ pt for 2 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    ...
    hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 1 AK8 inc jet", 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    hresponseLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 2 AK8 inc jet", 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    // different binnings b/t reco and gen --
    // NOTE: for the Mu Pt + Leading Jet Pt (AK8) R21 ratio, we account for bin migrations with a different fiducial selection at reco and gen levels
    // In order to not have empty diagonal elements in the migration matrix, we have chosen different binnings for reco and gen level, as they have different
    // minimum values due to cuts on the objects
    // LepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold", "lepton pt plus LJ pt for 1 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios_RECO, lepJetAK8Pt_ZRatios_RECO);
    // LepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold", "lepton pt plus LJ pt for 2 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios_RECO, lepJetAK8Pt_ZRatios_RECO);
    // genLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold", "gen lepton pt plus LJ pt for 1 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    // genLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold", "gen lepton pt plus LJ pt for 2 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    // hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold", "hresp lepton pt plus LJ pt for 1 AK8 inc jet", nLepJetAK8Pt_ZRatios_RECO, lepJetAK8Pt_ZRatios_RECO, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    // hresponseLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold", "hresp lepton pt plus LJ pt for 2 AK8 inc jet", nLepJetAK8Pt_ZRatios_RECO, lepJetAK8Pt_ZRatios_RECO, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    // hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 1 AK8 inc jet", nLepJetAK8Pt_ZRatios_RECO, lepJetAK8Pt_ZRatios_RECO, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    // hresponseLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 2 AK8 inc jet", nLepJetAK8Pt_ZRatios_RECO, lepJetAK8Pt_ZRatios_RECO, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    
    // 3 jet inc. dist.'s --
    LepPtPlusLeadingJetAK8Pt_Zinc3jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zinc3jet_TUnfold", "lepton pt plus LJ pt for 3 AK8 inc jet", lpT_LJpT, 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT);
    genLepPtPlusLeadingJetAK8Pt_Zinc3jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zinc3jet_TUnfold", "gen lepton pt plus LJ pt for 3 AK8 inc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    ...
    hresponseLepPtPlusLeadingJetAK8Pt_Zinc3jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zinc3jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 3 AK8 inc jet", 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    ...
    LepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold", "lepton pt plus LJ pt for 2 AK8 exc jet", lpT_LJpT, 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT);
    LepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold = newTH1D("LepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold", "lepton pt plus LJ pt for 3 AK8 exc jet", lpT_LJpT, 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT);
    genLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold", "gen lepton pt plus LJ pt for 1 AK8 exc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    genLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold", "gen lepton pt plus LJ pt for 2 AK8 exc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    genLepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold = newTH1D("genLepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold", "gen lepton pt plus LJ pt for 3 AK8 exc jet", lpT_LJpT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    ...
    hresponseLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 1 AK8 exc jet", 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    hresponseLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 2 AK8 exc jet", 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);
    hresponseLepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus LJ pt for 3 AK8 exc jet", 2 * nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios_SPLIT, nLepJetAK8Pt_ZRatios, lepJetAK8Pt_ZRatios);

    // Lepton Pt + HT,2/2 (AK8) ---
    double lepJetAK8HTover2_ZRatios_SPLIT[ (2 * nLepJetAK8HTover2_ZRatios) + 1 ];
    splitBinsInTwoForTUnfold(nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT);

    // inclusive
    LepPtPlusHT2over2AK8_Zinc2jet_TUnfold = newTH1D("LepPtPlusHT2over2AK8_Zinc2jet_TUnfold", "lepton pt plus Ht,2/2 for 2 AK8 inc jet", lpT_HTover2, 2 * nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT);
    LepPtPlusHT2over2AK8_Zinc3jet_TUnfold = newTH1D("LepPtPlusHT2over2AK8_Zinc3jet_TUnfold", "lepton pt plus Ht,2/2 for 3 AK8 inc jet", lpT_HTover2, 2 * nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT);
    genLepPtPlusHT2over2AK8_Zinc2jet_TUnfold = newTH1D("genLepPtPlusHT2over2AK8_Zinc2jet_TUnfold", "gen lepton pt plus Ht,2/2 for 2 AK8 inc jet", lpT_HTover2, nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios);
    genLepPtPlusHT2over2AK8_Zinc3jet_TUnfold = newTH1D("genLepPtPlusHT2over2AK8_Zinc3jet_TUnfold", "gen lepton pt plus Ht,2/2 for 3 AK8 inc jet", lpT_HTover2, nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios);
    hresponseLepPtPlusHT2over2AK8_Zinc2jet_TUnfold = newTH2D("hresponseLepPtPlusHT2over2AK8_Zinc2jet_TUnfold", "hresp lepton pt plus Ht,2/2 for 2 AK8 inc jet", 2 * nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT, nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios);
    hresponseLepPtPlusHT2over2AK8_Zinc3jet_TUnfold = newTH2D("hresponseLepPtPlusHT2over2AK8_Zinc3jet_TUnfold", "hresp lepton pt plus Ht,2/2 for 3 AK8 inc jet", 2 * nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT, nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios);
    hresponseLepPtPlusHT2over2AK8_Zinc2jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusHT2over2AK8_Zinc2jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus Ht,2/2 for 2 AK8 inc jet", 2 * nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT, nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios);
    hresponseLepPtPlusHT2over2AK8_Zinc3jet_TUnfold_NOEFFWEIGHTS = newTH2D("hresponseLepPtPlusHT2over2AK8_Zinc3jet_TUnfold_NOEFFWEIGHTS", "hresp lepton pt plus Ht,2/2 for 3 AK8 inc jet", 2 * nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios_SPLIT, nLepJetAK8HTover2_ZRatios, lepJetAK8HTover2_ZRatios);
