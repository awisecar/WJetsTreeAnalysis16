...
void ZJetsAndDPS::Loop(bool hasRecoInfo, bool hasGenInfo, int year, int doQCD, bool doSSign, bool doInvMassCut, int doBJets, int doPUStudy, bool doFlat, bool useRoch, bool doVarWidth){
    ...
    // for (Long64_t jentry(0); jentry < 100000; jentry++){
        ...
        // 1 == CSVv2 (2017 only)
        // 2 == SV inside jet
        int whichBTagger(0); // we use DeepCSV by default
        ...
        if (hasRecoInfo) {
            ...
            for (unsigned short i(0); i < nTotJets; i++) {
                ...
                jetStruct jet = {JetAk04Pt->at(i), JetAk04Eta->at(i), JetAk04Phi->at(i), JetAk04E->at(i), i, passBJets, 0, 0, jetAK4bDiscScore, JetAk04hasGoodSV->at(i)};
                ...
                if ( jetPassesLoosePtCut && jetPassesEtaCut && jetPassesIdCut && jetPassesPuIdCut ) {
                    ...
                    if (jetPassesPtCut){ // demand analysis selection jet pT cut when counting b-jets
                        ...
                        // Use the passBJets switch if using DeepCSV or CSVv2
                        ...
                        // Use presence of SV in jet in using this to veto
                        else{
