...
void ZJetsAndDPS::Loop(bool hasRecoInfo, bool hasGenInfo, int year, int doQCD, bool doSSign, bool doInvMassCut, int doBJets, int doPUStudy, bool doFlat, bool useRoch, bool doVarWidth){
    ...
    //==========================================================================================================//
    //     Theoretical Uncertainties (QCD scales, PDF, alpha-s)     //
    //==============================================================//
    ...
    std::cout << "doTheoryUncert: " << doTheoryUncert << std::endl;
    std::cout << "whichTheoryUncert: " << whichTheoryUncert << std::endl;
    std::cout << "doGenNloEWcorr: " << doGenNloEWcorr << std::endl;
    ...
    // for (Long64_t jentry(0); jentry < 50000; jentry++){
        ...
        if (hasGenInfo){
            ...
            for (unsigned short i(0); i < nTotGenLeptons; i++){
                ...
                if (lepSelector && GLepBarePrompt->at(i) && GLepBareSt->at(i) == 1
                    ...
                    // Have to set gen muon pT cut at a common point for all years,
                    // which must be higher than the highest trigger threshold
                    double genLepPtCut = 30.;
            ...
            if (nGenLeptons >= 2){
                ...
                if (doW){
                    ...
                    if (genMT >= MTCut && genLepton2.pt >= METcut) passesGenLeptonCut = 1; // ALW 10 JUNE 20 -- this is the NOMINAL CUT
                    // if (genMT >= 30. && genLepton2.pt >= METcut) passesGenLeptonCut = 1; // ALW 10 JUNE 20 -- this is a cut used to study migrations across MT boundary for unfolding
        ...
        TLorentzVector leadJ_20, secondJ_20, jet1Plus2_20;
                ...
                if (!isData && doBTagSFs){
                    ...
                    if (year == 2016){
                        ...
                        if (whichBTagger == 0){
                            ...
                            float btagEffTruthB[9]     = {0.695652, 0.798272, 0.824619, 0.82926, 0.827961, 0.819452, 0.795245, 0.743553, 0.68178};
                            float btagEffTruthC[9]     = {0.241268, 0.250869, 0.230782, 0.224063, 0.225189, 0.230567, 0.227024, 0.240288, 0.293142};
                            float btagEffTruthLight[9] = {0.0409377, 0.0318379, 0.0248322, 0.0232758, 0.0229497, 0.0259721, 0.0284908, 0.0371512, 0.0494051};
                        ...
                        float btagEffTruthB[9]     = {0.698872, 0.798232, 0.82479, 0.831134, 0.830648, 0.825972, 0.79912, 0.770872, 0.684439};
                        float btagEffTruthC[9]     = {0.258248, 0.274959, 0.257635, 0.250921, 0.251861, 0.249294, 0.262546, 0.266937, 0.244274};
                        float btagEffTruthLight[9] = {0.0459899, 0.0341422, 0.027024, 0.0257825, 0.0263551, 0.0303349, 0.0350821, 0.0470496, 0.0622152};
        ...
        unsigned short nTotJetsAK8(0), nJetsAK8NoDRCut(0), nGoodJetsAK8(0), nGoodJetsAK8_30(0);
        double jetsAK8HT(0); 

        vector<jetStruct> jetsAK8, jetsAK8NoDRCut, jetsAK8_30; 

        TLorentzVector newLeadJAK8, newSecondJAK8;
        TLorentzVector newLeadJAK8_30, newSecondJAK8_30, jet1Plus2AK8_30;
        ...
        if (hasRecoInfo){
            ...
            for (unsigned short i(0); i < nTotJetsAK8; i++){
                ...
                // NOTE: in the W+jets analysis, all b-tagging is usually done with AK4 jets, not AK8 jets
                // nominal btagging criterion
                ...
                // loose pt cut
                bool jetAK8PassesLoosePtCut(jetAK8.pt >= 30.);
        ...
        //============================================//
        // bool passesGenJetCut(1);
        unsigned short nTotGenJetsAK8(0), nGenJetsAK8NoDRCut(0), nGoodGenJetsAK8(0), nGoodGenJetsAK8_30(0);
        double genJetsAK8HT(0);
        vector<jetStruct> genJetsAK8, genJetsAK8NoDRCut, genJetsAK8_30;
        TLorentzVector genNewLeadJAK8, genNewSecondJAK8, genJet1Plus2AK8;
        ...
        if (hasGenInfo){
            ...
            for (unsigned short i(0); i < nTotGenJetsAK8; i++){
				...
				if (genJetAK8.pt >= 30. && fabs(genJetAK8.eta) <= 4.7){
        ...
        double genMindRj04Pt30mu(99999);
        ...
        if (hasRecoInfo){
            ...
            for (unsigned short i(0); i < nJetsAK8NoDRCut; i++){
                ...
                if (jetsAK8NoDRCut[i].pt >= 50. && jetsAK8NoDRCut[i].passDR04) tmpJetsAK8.push_back(jetsAK8NoDRCut[i]);
                if (jetsAK8NoDRCut[i].pt >= 30. && jetsAK8NoDRCut[i].passDR04) jetsAK8_30.push_back(jetsAK8NoDRCut[i]);
            ...
            nGoodJetsAK8_30 = jetsAK8_30.size();
            ...
            if (nGoodJetsAK8_30 >= 1) sort(jetsAK8_30.begin(), jetsAK8_30.end(), JetDescendingOrder);
            // -----------------------------------------------------------------------------------------------------------------------------
            

            if (nGoodJets_20 >= 1) leadJ_20.SetPtEtaPhiE(jets_20[0].pt, jets_20[0].eta, jets_20[0].phi, jets_20[0].energy);
            if (nGoodJets_20 >= 2){
            ...
            if (nGoodJetsAK8_30 >= 1) newLeadJAK8_30.SetPtEtaPhiE(jetsAK8_30[0].pt, jetsAK8_30[0].eta, jetsAK8_30[0].phi, jetsAK8_30[0].energy);
            if (nGoodJetsAK8_30 >= 2){
                newSecondJAK8_30.SetPtEtaPhiE(jetsAK8_30[1].pt, jetsAK8_30[1].eta, jetsAK8_30[1].phi, jetsAK8_30[1].energy);
                jet1Plus2AK8_30 = newLeadJAK8_30 + newSecondJAK8_30;
            }
        ...
        if (hasGenInfo){
            ...
            for (unsigned short i(0); i < nGenJetsAK8NoDRCut; i++){
                ...
                if (genJetsAK8NoDRCut[i].pt >= 50. && fabs(gjetAK8r.Rapidity()) <= jetEtaCutMax/10. && genJetsAK8NoDRCut[i].passDR04) tmpJetsAK8.push_back(genJetsAK8NoDRCut[i]);
                if (genJetsAK8NoDRCut[i].pt >= 30. && fabs(gjetAK8r.Rapidity()) <= jetEtaCutMax/10. && genJetsAK8NoDRCut[i].passDR04) genJetsAK8_30.push_back(genJetsAK8NoDRCut[i]);
            ...
            nGoodGenJetsAK8_30 = genJetsAK8_30.size();
            ...
            if (nGoodGenJetsAK8_30 >= 1) sort(genJetsAK8_30.begin(), genJetsAK8_30.end(), JetDescendingOrder);
            // -----------------------------------------------------------------------------------------------------------------------------
            ...
            if (nGoodGenJetsAK8 >= 1) {
                genNewLeadJAK8.SetPtEtaPhiE(genJetsAK8[0].pt, genJetsAK8[0].eta, genJetsAK8[0].phi, genJetsAK8[0].energy);
            }
            if (nGoodGenJetsAK8 >= 2) {
                genNewSecondJAK8.SetPtEtaPhiE(genJetsAK8[1].pt, genJetsAK8[1].eta, genJetsAK8[1].phi, genJetsAK8[1].energy);
                genJet1Plus2AK8 = genNewLeadJAK8 + genNewSecondJAK8;
            }
            ...
            // calculate the closest gen jet w.r.t to the muon for genJets collection
            if (nGoodGenJets >= 1 && passesGenLeptonCut){
                for (unsigned short i(0); i < nGoodGenJets; i++){
                    double dRGenjmu(9999);
					dRGenjmu = fabs(deltaR(genJets[i].phi, genJets[i].eta, genLepton1.phi, genLepton1.eta));
                    if (dRGenjmu < genMindRj04Pt30mu) genMindRj04Pt30mu = dRGenjmu;
                }
            }
        ...
        if (hasGenInfo && passesGenLeptonCut && passesGenJetCut){
            ...
            genZNGoodJets_Zexc_TUnfold->Fill(nGoodGenJets, genWeight);
            ...
            genZNGoodJetsAK8_Zexc_TUnfold->Fill(nGoodGenJetsAK8, genWeight);
            ...
            if (nGoodGenJets_20 >= 2){
                ...
                genSecondJetPt_Zinc2jet_TUnfold->Fill(genJets_20[1].pt, genWeight);
            ...
            if (nGoodGenJetsAK8 >= 1){
                ...
                genFirstJetAK8AbsRapidity_Zinc1jet_TUnfold->Fill(fabs(genNewLeadJAK8.Rapidity()), genWeight);
                gendPhiLepJet1AK8_Zinc1jet_TUnfold->Fill(deltaPhi(genLep1, genNewLeadJAK8), genWeight);
            ...
            if (nGoodGenJets >= 2){
                ...
                gendiJetMass_Zinc2jet_TUnfold->Fill(genJet1Plus2.M(), genWeight);
                ...
                gendRJets_Zinc2jet_TUnfold->Fill(deltaRYPhi(genNewLeadJ, genNewSecondJ), genWeight);
                ...
                gendPhiLepJet2_Zinc2jet_TUnfold->Fill(deltaPhi(genLep1, genNewSecondJ), genWeight);
            ...
            if (nGoodGenJetsAK8 >= 2){
                ...
                gendiJetAK8Mass_Zinc2jet_TUnfold->Fill(genJet1Plus2AK8.M(), genWeight);
        ...
        if (hasRecoInfo && passesLeptonCut && passesJetCut){
            ...
            ZNGoodJets_Zexc_TUnfold->Fill(nGoodJets, weight);
            ...
            ZNGoodJetsAK8_Zexc_TUnfold->Fill(nGoodJetsAK8, weight);
            ...
            if (nGoodJets_20 >= 2){
                ...
                SecondJetPt_Zinc2jet_TUnfold->Fill(jets_20[1].pt, weight);
                ...
                diJetMass_Zinc2jet_TUnfold->Fill(jet1Plus2_20.M(), weight);
            ...
            if (nGoodJetsAK8_30 >= 1){
                FirstJetAK8Pt_Zinc1jet_TUnfold->Fill(jetsAK8_30[0].pt, weight);
                if ( (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                    LepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold->Fill(lepton1.pt + jetsAK8_30[0].pt, weight);
                } 

                if (nGoodJetsAK8_30 == 1){
                    if ( (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                        LepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold->Fill(lepton1.pt + jetsAK8_30[0].pt, weight);
                    }
                }

            }
            if (nGoodJetsAK8_30 >= 2){
                SecondJetAK8Pt_Zinc2jet_TUnfold->Fill(jetsAK8_30[1].pt, weight);
                ...
                if (nGoodJetsAK8_30 == 2){
                    if ( (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                        LepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold->Fill(lepton1.pt + jetsAK8_30[0].pt, weight);
                    }
                }
            ...
            if (nGoodJets >= 2){
                ...
                SecondJetAbsRapidity_Zinc2jet_TUnfold->Fill(fabs(newSecondJ.Rapidity()), weight);
                ...
                dRJets_Zinc2jet_TUnfold->Fill(deltaRYPhi(newLeadJ, newSecondJ), weight);
                ...
                dPhiLepJet2_Zinc2jet_TUnfold->Fill(deltaPhi(lep1, newSecondJ), weight);
        ...
        if (hasRecoInfo && hasGenInfo && passesGenLeptonCut && passesLeptonCut){
            ...
            hresponseZNGoodJets_Zexc_TUnfold->Fill(nGoodJets, nGoodGenJets, weight);
            hresponseZNGoodJets_Zexc_TUnfold_NOEFFWEIGHTS->Fill(nGoodJets, nGoodGenJets, genWeight);
            ...
            hresponseZNGoodJetsAK8_Zexc_TUnfold->Fill(nGoodJetsAK8, nGoodGenJetsAK8, weight);
            hresponseZNGoodJetsAK8_Zexc_TUnfold_NOEFFWEIGHTS->Fill(nGoodJetsAK8, nGoodGenJetsAK8, genWeight);
            ...
            if (nGoodGenJets_20 >= 1 && nGoodJets_20 >= 1){
                ...
                hresponseFirstJetPt_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(jets_20[0].pt, genJets_20[0].pt, genWeight);
                ...
                hresponseLepPtPlusLeadingJetPt_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jets_20[0].pt, genLep1.Pt()+genJets_20[0].pt, genWeight);
                ...
                if (nGoodGenJets_20 == 1 && nGoodJets_20 == 1){
                    ...
                    hresponseLepPtPlusLeadingJetPt_Zexc1jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jets_20[0].pt, genLep1.Pt()+genJets_20[0].pt, genWeight);
                }
            }
            if (nGoodGenJets_20 >= 2 && nGoodJets_20 >= 2){
                hresponseSecondJetPt_Zinc2jet  ->Fill(jets_20[1].pt, genJets_20[1].pt, weight);
                hresponseSecondJetPt_Zinc2jet_TUnfold->Fill(jets_20[1].pt, genJets_20[1].pt, weight);
                hresponseSecondJetPt_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(jets_20[1].pt, genJets_20[1].pt, genWeight);
                ...
                hresponseLepPtPlusLeadingJetPt_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jets_20[0].pt, genLep1.Pt()+genJets_20[0].pt, genWeight);
                ...
                if (nGoodGenJets_20 == 2 && nGoodJets_20 == 2){
                    ...
                    hresponseLepPtPlusLeadingJetPt_Zexc2jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jets_20[0].pt, genLep1.Pt()+genJets_20[0].pt, genWeight);
                }
            }
            if (nGoodGenJets_20 >= 3 && nGoodJets_20 >= 3){
                ...
                hresponseLepPtPlusLeadingJetPt_Zinc3jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jets_20[0].pt, genLep1.Pt()+genJets_20[0].pt, genWeight);
                ...
                if (nGoodGenJets_20 == 3 && nGoodJets_20 == 3){
                    ...
                    hresponseLepPtPlusLeadingJetPt_Zexc3jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jets_20[0].pt, genLep1.Pt()+genJets_20[0].pt, genWeight);
                }
            }
            ...
            if (nGoodGenJets >= 2 && nGoodJets_20 >= 2){
                hresponsediJetMass_Zinc2jet_TUnfold->Fill(jet1Plus2_20.M(), genJet1Plus2.M(), weight);
                hresponsediJetMass_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(jet1Plus2_20.M(), genJet1Plus2.M(), genWeight);
            }
            ...
            if (nGoodGenJetsAK8 >= 1 && nGoodJetsAK8_30 >= 1){
                if ( (genLep1.Pt() >= 50.) && (genJetsAK8[0].pt >= 100.) && (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                    hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold->Fill(lepton1.pt + jetsAK8_30[0].pt, genLep1.Pt()+genJetsAK8[0].pt, weight);
                    hresponseLepPtPlusLeadingJetAK8Pt_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jetsAK8_30[0].pt, genLep1.Pt()+genJetsAK8[0].pt, genWeight);
                } 
                if (nGoodGenJetsAK8 == 1 && nGoodJetsAK8_30 == 1){
                    if ( (genLep1.Pt() >= 50.) && (genJetsAK8[0].pt >= 100.) && (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                        hresponseLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold->Fill(lepton1.pt + jetsAK8_30[0].pt, genLep1.Pt()+genJetsAK8[0].pt, weight);
                        hresponseLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jetsAK8_30[0].pt, genLep1.Pt()+genJetsAK8[0].pt, genWeight);
                    }
                }
            }
            if (nGoodGenJetsAK8 >= 2 && nGoodJetsAK8_30 >= 2){
                hresponsediJetAK8Mass_Zinc2jet_TUnfold->Fill(jet1Plus2AK8_30.M(), genJet1Plus2AK8.M(), weight);
                hresponsediJetAK8Mass_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(jet1Plus2AK8_30.M(), genJet1Plus2AK8.M(), genWeight);
                if ( (genLep1.Pt() >= 50.) && (genJetsAK8[0].pt >= 100.) && (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                ...
                if (nGoodGenJetsAK8 == 2 && nGoodJetsAK8_30 == 2){
                    if ( (genLep1.Pt() >= 50.) && (genJetsAK8[0].pt >= 100.) && (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
                        hresponseLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold->Fill(lepton1.pt + jetsAK8_30[0].pt, genLep1.Pt()+genJetsAK8[0].pt, weight);
                        hresponseLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jetsAK8_30[0].pt, genLep1.Pt()+genJetsAK8[0].pt, genWeight);
                    }
                }
            }
            if (nGoodGenJetsAK8 >= 3 && nGoodJetsAK8_30 >= 3){
                if ( (genLep1.Pt() >= 50.) && (genJetsAK8[0].pt >= 100.) && (lepton1.pt >= 50.) && (jetsAK8_30[0].pt >= 30.) ){
            ...
            if (nGoodGenJets >= 1 && nGoodJets >= 1){
                ...
                hresponsedPhiLepJet1_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(deltaPhi(lep1, newLeadJ), deltaPhi(genLep1, genNewLeadJ), genWeight);
                ...
                hresponseFirstJetAbsRapidity_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(fabs(newLeadJ.Rapidity()), fabs(genNewLeadJ.Rapidity()), genWeight);
            ...
            if (nGoodGenJetsAK8 >= 1 && nGoodJetsAK8 >= 1){
                ...
                hresponseFirstJetAK8AbsRapidity_Zinc1jet_TUnfold->Fill(fabs(newLeadJAK8.Rapidity()), fabs(genNewLeadJAK8.Rapidity()), weight);
                hresponseFirstJetAK8AbsRapidity_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(fabs(newLeadJAK8.Rapidity()), fabs(genNewLeadJAK8.Rapidity()), genWeight);
                hresponsedPhiLepJet1AK8_Zinc1jet_TUnfold->Fill(deltaPhi(lep1, newLeadJAK8), deltaPhi(genLep1, genNewLeadJAK8), weight);
                hresponsedPhiLepJet1AK8_Zinc1jet_TUnfold_NOEFFWEIGHTS->Fill(deltaPhi(lep1, newLeadJAK8), deltaPhi(genLep1, genNewLeadJAK8), genWeight);
                ...
                if (nGoodGenJetsAK8 == 1 && nGoodJetsAK8 == 1){
                    ...
                    // hresponseLepPtPlusLeadingJetAK8Pt_Zexc1jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jetsAK8[0].pt, genLep1.Pt()+genJetsAK8[0].pt, genWeight);
                }
            }
            //-- Second Jet Pt
            if (nGoodGenJets >= 2 && nGoodJets >= 2){
                ...
                hresponsedRJets_Zinc2jet_TUnfold->Fill(deltaRYPhi(newLeadJ, newSecondJ), deltaRYPhi(genNewLeadJ, genNewSecondJ), weight);
                hresponsedRJets_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(deltaRYPhi(newLeadJ, newSecondJ), deltaRYPhi(genNewLeadJ, genNewSecondJ), genWeight);
                ...
                hresponsedPhiLepJet2_Zinc2jet_TUnfold->Fill(deltaPhi(lep1, newSecondJ), deltaPhi(genLep1, genNewSecondJ), weight);
                hresponsedPhiLepJet2_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(deltaPhi(lep1, newSecondJ), deltaPhi(genLep1, genNewSecondJ), genWeight);
                ...
                hresponseSecondJetAbsRapidity_Zinc2jet_TUnfold->Fill(fabs(newSecondJ.Rapidity()), fabs(genNewSecondJ.Rapidity()), weight);
                hresponseSecondJetAbsRapidity_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(fabs(newSecondJ.Rapidity()), fabs(genNewSecondJ.Rapidity()), genWeight);
            ...
            if (nGoodGenJetsAK8 >= 2 && nGoodJetsAK8 >= 2){
                ...
                hresponsedRJetsAK8_Zinc2jet_TUnfold_NOEFFWEIGHTS->Fill(deltaRYPhi(newLeadJAK8, newSecondJAK8), deltaRYPhi(genNewLeadJAK8, genNewSecondJAK8), genWeight);
                ...
                if (nGoodGenJetsAK8 == 2 && nGoodJetsAK8 == 2){
                    ...
                    // hresponseLepPtPlusLeadingJetAK8Pt_Zexc2jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jetsAK8[0].pt, genLep1.Pt()+genJetsAK8[0].pt, genWeight);
                }
            }
            //-- Third Jet Pt
            ...
            if (nGoodGenJetsAK8 >= 3 && nGoodJetsAK8 >= 3){
                ...
                if (nGoodGenJetsAK8 == 3 && nGoodJetsAK8 == 3){
                    ...
                    hresponseLepPtPlusLeadingJetAK8Pt_Zexc3jet_TUnfold_NOEFFWEIGHTS->Fill(lepton1.pt + jetsAK8[0].pt, genLep1.Pt()+genJetsAK8[0].pt, genWeight);
                }
            }
            //-- Fourth Jet Pt
    ...
    for(unsigned short i(0); i < numbOfHistograms; i++){
        ...
        if ( !hasGenInfo && ((hName.find("gen") != string::npos) || (hName.find("hresponse") != string::npos)) ){
